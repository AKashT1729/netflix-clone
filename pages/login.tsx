  ...
  const onSubmit: SubmitHandler<Inputs> = async ({email,password}) => {
    ...
    return (
        <div className=" relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent">
            ...
            <Image
                src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*5lyavS59mazOFnb55Z6znQ.png"
                layout="fill"
        ...
        action="" className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14">
            ...
            <div className="space-y-4">
                ...
                <label htmlFor="" className=" inline-block w-full">
                    ...
                    {errors.password && <p className="p-1 text-[13px] font-light text-red-500">Your password must contain between 4 and 60 characters.</p>} 
                </label>
            </div>
